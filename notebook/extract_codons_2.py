...
def sam2pair_extract(sam2pairwise_file, output):
    
    s2p_out = pd.read_csv(sam2pairwise_file, sep='\t')
...
def make_codons_dict(args):
    '''
    input: sam2pairwise table created from sam2pair_extract
    '''
...
if __name__ == '__main__':
    ...
    PARSER.add_argument('--sam2pairwise', type=str, required=True)
